...
// Maps old App\Services\Ontology\Parsers\OwlParser to the new
// Youri\vandenBogert\Software\ParserOwl\OwlParser class.
...
spl_autoload_register(function (string $class): void {
    ...
    $aliases = [
        'App\Services\Ontology\Parsers\OwlParser' => \Youri\vandenBogert\Software\ParserOwl\OwlParser::class,
    ];
